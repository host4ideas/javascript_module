...
Añadimos un selector con los idiomas

- posicionar con la cabecera en una sola linea con el selector
- el selector se carga junto con el formulario
- al cambiar el selector obtener del servidor los textos de los idiomas
- cargar los label con los nuevos textos
- crear un fichero json para los textos de cada idioma: en.json , es.json , ...
- investigar el uso de la api de google para tratucir los idiomas desde php, es de pago asi dejamos los textos ya traducidos
- http://spanish.nicetranslator.com/lowres.php#

Formato de datos :
- id_label: texto con solo dos campos tengo bastante un array asociativo en php y json para moverlo
*/
...
?>
	...
	<div id='contForm'>
		<form id='registro' name="registro" onsubmit="return validar()" novalidate>
			...
			<div id="col1">
				<label id='lblNombre' for="Nombre">Nombre</label><input type="text" required class='' id="Nombre" name="Nombre" value='' size="20" maxlength="50" />
				<label id='lblUsuario' for="Usuario">Usuario</label><input type="text" required class='' id="Usuario" name="Usuario" value='' size="20" maxlength="30" />
